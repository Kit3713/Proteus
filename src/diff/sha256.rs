...
pub fn hex_digest(bytes: &[u8]) -> String {
    ...
    // Safety: HEX contains only ASCII so `buf` is valid UTF-8.
...
mod tests {
    ...
    #[test]
    fn empty_string_digest_matches_fips_vector() {
    ...
    #[test]
    fn one_million_a_digest_matches_fips_vector() {
        // FIPS 180-4 test vector: SHA-256("a" * 1_000_000) =
