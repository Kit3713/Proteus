...
//!
//! In-tree to avoid pulling in `sha2` for the single use of stamping a
//! content hash into the managed-file header. ~3 KB of code, zero deps.
...
mod tests {
    ...
    fn long_input_matches_known_vector() {
        // 64-byte input crosses one full block plus padding.
        let s = b"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
        assert_eq!(
            hex(s),
