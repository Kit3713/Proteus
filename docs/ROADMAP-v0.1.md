...
> **Archived 2026-05-07.** Phases A–G shipped in v0.2.7-alpha. The few remaining ⏳ items have been carried forward into the new cycle. See [`ROADMAP.md`](ROADMAP.md) for the active v0.3 "Reach + Persona" roadmap.
