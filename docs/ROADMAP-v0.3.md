# Roadmap — v0.3 "Reach + Persona" (archived)

> **Archived 2026-05-08.** The v0.3 "Reach + Persona" cycle shipped; the
> bug-and-vulnerability-hunt tail (v0.4.0-beta1) is documented here too. The
> active cycle is now v0.4.x "Hardening Across Streams" — see
> [`ROADMAP.md`](ROADMAP.md). The four ⏳ items left at the bottom of this
> document have been carried forward into the relevant streams of the active
> roadmap. For per-version release notes, see [`CHANGELOG.md`](../CHANGELOG.md).
> The phase-A-through-G build-out lives in [`ROADMAP-v0.1.md`](ROADMAP-v0.1.md).
